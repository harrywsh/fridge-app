    ...
    render() {
        return (
            <View style={_style.IntroRect}>
                ...
                <Text style={[_style.IntroText, { top: 45 }]}>
                    在独立的智能净味装置内， 漩涡吸风舱将冰箱内空气持续吸入超磁感放电场，
                    空气经过电场被电离，释放出大量活性离子， 以风暴席卷式将异味和细菌分子快速分解为无害小分子。
                </Text>
                <Image style={[_style.IntroImage, { top: 45 }]} source={require('../assets/1.jpg')}></Image>

                <Text style={[_style.TitleText, { top: 170 }]}>
                    高活性金属催化
                </Text>
                <Text style={[_style.IntroText, { top: 195 }]}>
                    同时装置内搭载高能活性金属催化剂 进一步加速催化活性离子与异味{'&'}细菌分子反应，
                    并持续释放高活性物质， 将异味和细菌分子彻底分解。
                </Text>
                <Image style={[_style.IntroImage, { top: 195 }]} source={require('../assets/2.jpg')}></Image>

                <Text style={[_style.TitleText, { top: 315 }]}>
                    技术详解
                </Text>
                <Text style={[_style.IntroText, { top: 340, width: (windowWidth - 40) * 0.9 }]}>
